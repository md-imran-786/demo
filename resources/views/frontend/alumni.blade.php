            ...
            <div class="col-xl-10 mx-auto">
               <div class="block block-themed">
                  <div class="block-header bg-default">
                     <h3 class="block-title">Alumni Student</h3>
                    ...
                    <div class="block-content">
                        <form name="alumni_student" action="{{route('student.store')}}" method="post">
                           @csrf
                            <input type="hidden" name="form_path" value="alumni_student">
                           <div class="form-group row">
                              ...
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="form-material floating">
                                       <input type="number" class="form-control" id="reg" name="registration_no" required="">
                              ...
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="form-material floating">
                                       <input type="number" class="form-control" id="sscroll" name="ssc_roll" required="">
                              ...
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="form-material floating">
                                       <textarea class="form-control" id="parmanent_address" name="permanent_address" rows="4" placeholder="Parmanent Address" required=""></textarea>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="row">
                              <div class="col-12">
                                 <div class="form-group pt-5 mt-5">
                                    <h5>Business Information (if any)</h5>
                                 </div>
                              </div>
